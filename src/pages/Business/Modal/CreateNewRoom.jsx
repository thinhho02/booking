...
const typeRoom = ["Single", "Double", "Suite", "Deluxe", "Family", "Twin"]

const bedType = ["Single", "Double", "Queen", "King", "Twin"]
...
function CreateNewRoom({ onClose, hotelId }) {
    ...
    const handleDeleteTags = (i) => {
        const newTags = amenitiesTags.filter((tag, index) => index !== i);
        setAmenitiesTags(newTags);
    }
    const handleAddition = (tag) => {
        setAmenitiesTags((prevTags) => {
            return [...prevTags, tag];
        });
    };

    const handleServicesDeleteTags = (i) => {
        const newTags = servicesTags.filter((tag, index) => index !== i);
        setServicesTags(newTags);
    }
    const handleServicesAddition = (tag) => {
        setServicesTags((prevTags) => {
            return [...prevTags, tag];
        });
    };
